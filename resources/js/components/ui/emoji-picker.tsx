...
function EmojiPickerContent({
    ...
    return (
        <EmojiPickerPrimitive.Viewport
            // 🌟 FIX 2: Tambahkan overflow-y-auto overscroll-contain touch-pan-y
            className={cn("outline-hidden relative flex-1 overflow-y-auto overscroll-contain touch-pan-y", className)}
